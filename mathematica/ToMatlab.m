...
(* More added by Alon *)
ToMatlabaux[Gamma] := "gamma"
ToMatlabaux[HypergeometricPFQ] := "hypergeom"
ToMatlabaux[SinIntegral] := "sinint"
ToMatlabaux[CosIntegral] := "cosint"
...
(* Added by Alon *)
ToMatlabaux[Gamma[a_,z_]] := "igamma(" <> ToMatlabaux[a] <> "," <> ToMatlabaux[z] <> ")"
